...
if(isset($_POST['save'])) {
	...
	$db->query("UPDATE users SET email='$email',bio='$bio',instagram_username='$instagram_username' WHERE id='".$user['id']."'");
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form action="" method="post" role="form" enctype="multipart/form-data" id="settings">
				...
				<div class="form-group has-feedback">
					<label for="city"><i class="fa fa-instagram"></i> <?php echo $lang['Instagram_Username']?></label>
					<input type="text" name="instagram_username" class="form-control" placeholder="Enter your instagram username" value="<?php echo $user['instagram_username']?>" autocomplete="off">
					<small class="text-muted"> <?php echo $lang['Instagram_Import_Notice']?> </small>
				</div>
...
<div class="col-md-4">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<img src="<?php echo getProfilePicture($domain,$user)?>" class="img-responsive img-rounded center-block" height="128" width="128">
		</div>
	</div>
</div>
<!-- END panel-->
