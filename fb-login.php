...
if ($user) {
  try {
    ...
    if($check >= 1) {
     ...
     $db->query("INSERT INTO users(profile_picture,full_name,email,registered,country,energy,ip,age,gender,latitude,longitude,local_range,last_login) VALUES ('$profile_picture','$full_name','$email','$time','$country','10','$ip','$age','$gender','$latitude','$longitude','0,150',UNIX_TIMESTAMP())");
